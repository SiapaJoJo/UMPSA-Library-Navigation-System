        ...
        <footer class="relative bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 overflow-hidden border-t border-gray-200 dark:border-gray-700">
            ...
            <div class="relative z-10 max-w-7xl mx-auto py-16 md:py-20 px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
                    <div class="md:col-span-1">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-6">
                            Navigate the Universiti Malaysia Pahang Al-Sultan Abdullah (UMPSA) Library using LibNav, a modern digital navigation system designed to help users explore library spaces, facilities, and services efficiently.
                        </p>
                    </div>
                    <div>
                        ...
                        <ul class="space-y-3 text-sm">
                            ...
                            <li><a href="{{ route('guest.contact.index') }}" class="text-gray-700 dark:text-gray-300 hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors duration-200 flex items-center">
                                <svg class="w-4 h-4 mr-2 text-gray-800 dark:text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                                </svg>
                                Contact Us
                    ...
                    <div>
                        <h3 class="text-lg font-bold mb-6 text-cyan-600 dark:text-cyan-400">Contact Information</h3>
                        <div class="text-sm text-gray-700 dark:text-gray-300 space-y-4">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 dark:text-gray-400">Universiti Malaysia Pahang Al-Sultan Abdullah</p>
                                    <p class="text-gray-600 dark:text-gray-400">26600 Pekan, Pahang, Malaysia</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <svg class="w-5 h-5 mr-3 mt-1 text-gray-800 dark:text-gray-200 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div>
                                    <p class="font-medium text-gray-900 dark:text-gray-100">Tel</p>
                                    <p class="text-gray-600 dark:text-gray-400">+609 431 5035 (Pekan)</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <svg class="w-5 h-5 mr-3 mt-1 text-gray-800 dark:text-gray-200 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 dark:text-gray-400">umplibrary@umpsa.edu.my</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <svg class="w-5 h-5 mr-3 mt-1 text-gray-800 dark:text-gray-200 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div>
                                    <p class="font-medium text-gray-900 dark:text-gray-100 mb-2">Operation Hours</p>
                                    <div class="text-xs text-gray-600 dark:text-gray-400 space-y-1.5">
                                        <p><span class="font-semibold">During Semester:</span> Mon-Fri: 8AM-7PM, Sat-Sun: Closed</p>
                                        <p><span class="font-semibold">Study/Exam Week:</span> Mon-Fri: 8AM-10PM, Sun: 9AM-4PM, Sat: Closed</p>
                                        <p><span class="font-semibold">Semester Break:</span> Mon-Thu: 8AM-5PM, Fri: 8AM-12:15PM & 2:45PM-5PM, Sat-Sun: Closed</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        <h3 class="text-lg font-bold mb-6 text-cyan-600 dark:text-cyan-400">Project Information</h3>
                        <div class="text-sm text-gray-700 dark:text-gray-300 space-y-3">
                            <div>
                                <p class="font-semibold text-gray-900 dark:text-gray-100 mb-1">LibNav – UMPSA Library Digital Navigation System</p>
                                <p class="text-gray-600 dark:text-gray-400">Final Year Project</p>
                            </div>
                            <div>
                                <p class="font-medium text-gray-900 dark:text-gray-100 mb-1">Developed by</p>
                                <p class="text-gray-600 dark:text-gray-400">Muhammad Tajul Afiq Bin Tajul Aris</p>
                            </div>
                            <div>
                                <p class="font-medium text-gray-900 dark:text-gray-100 mb-1">Universiti Malaysia Pahang Al-Sultan Abdullah</p>
                            </div>
                        </div>
                ...
                <div class="mt-12 pt-8 border-t border-gray-300 dark:border-gray-700 text-center">
                    <p class="text-gray-600 dark:text-gray-400 text-sm md:text-base">&copy; {{ date('Y') }} UMPSA Library. All rights reserved.</p>
                    <p class="text-gray-600 dark:text-gray-400 text-sm md:text-base mt-2">LibNav – Modern Digital Navigation System</p>
                </div>
            </div>
        </footer>
    </div>
