<x-admin-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Library Map</h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">Update map information</p>
            </div>
