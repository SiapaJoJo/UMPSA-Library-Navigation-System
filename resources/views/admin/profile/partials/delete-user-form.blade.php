<section class="space-y-6">
    <div class="p-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-xl">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" 
                               ...
                               name="password" 
                               required
                               class="w-full pl-10 pr-4 py-3 border border-gray-200 dark:border-gray-600 rounded-xl shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 @error('password', 'userDeletion') border-red-300 focus:ring-red-500 @enderror"
