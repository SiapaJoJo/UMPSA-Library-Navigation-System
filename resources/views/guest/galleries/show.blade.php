        ...
        <section class="relative w-full py-16 md:py-24 overflow-hidden">
            <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center">
                    ...
                    <h1 class="text-5xl md:text-7xl font-extrabold mb-4 bg-gradient-to-r from-pink-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">
                        {{ $gallery->title }}
                    </h1>
                    @if($gallery->category)
                        <p class="text-xl md:text-2xl text-gray-600">{{ $gallery->category }}</p>
                    @endif
                </div>
            </div>
        </section>
