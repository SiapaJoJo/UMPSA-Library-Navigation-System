            ...
            <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    <div class="inline-block mb-6">
                        <span class="text-sm font-semibold text-blue-600 uppercase tracking-wider bg-blue-50 px-4 py-2 rounded-full">Get in Touch</span>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-10 border border-gray-200/50">
                    <div class="flex items-center mb-8">
                        ...
                        <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900">Send us a Message</h2>
                    </div>
                    ...
                    <form action="{{ route('guest.contact.store') }}" method="POST" class="space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('name') }}"
                                           required
                                           class="w-full pl-12 pr-4 py-3.5 border-2 border-gray-200 rounded-2xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 @error('name') border-red-300 focus:ring-red-500 @enderror"
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" 
                                           ...
                                           value="{{ old('email') }}"
                                           required
                                           class="w-full pl-12 pr-4 py-3.5 border-2 border-gray-200 rounded-2xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 @error('email') border-red-300 focus:ring-red-500 @enderror"
                        ...
                        <div class="space-y-2">
                            <label for="phone" class="block text-sm font-bold text-gray-700">Phone (Optional)</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <input type="tel" 
                                       ...
                                       name="phone" 
                                       value="{{ old('phone') }}"
                                       class="w-full pl-12 pr-4 py-3.5 border-2 border-gray-200 rounded-2xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 @error('phone') border-red-300 focus:ring-red-500 @enderror"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('subject') }}"
                                       required
                                       class="w-full pl-12 pr-4 py-3.5 border-2 border-gray-200 rounded-2xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 @error('subject') border-red-300 focus:ring-red-500 @enderror"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <textarea id="message" 
                                          ...
                                          rows="6"
                                          required
                                          class="w-full px-4 py-3.5 border-2 border-gray-200 rounded-2xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 resize-none @error('message') border-red-300 focus:ring-red-500 @enderror"
                ...
                <div class="space-y-6">
                    <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-10 border border-gray-200/50">
                        ...
                        <div class="space-y-6">
                            <div class="group p-6 bg-gradient-to-r from-blue-50/80 to-indigo-50/80 backdrop-blur-sm rounded-2xl border-2 border-blue-100 hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
                            ...
                            <div class="group p-6 bg-gradient-to-r from-green-50/80 to-emerald-50/80 backdrop-blur-sm rounded-2xl border-2 border-green-100 hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
                                <div class="flex items-start space-x-4">
                            ...
                            <div class="group p-6 bg-gradient-to-r from-purple-50/80 to-violet-50/80 backdrop-blur-sm rounded-2xl border-2 border-purple-100 hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
                                <div class="flex items-start space-x-4">
                            ...
                            <div class="group p-6 bg-gradient-to-r from-orange-50/80 to-amber-50/80 backdrop-blur-sm rounded-2xl border-2 border-orange-100 hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
                                <div class="flex items-start space-x-4">
